...
function Portfolio1() {
 ...
 const homeRef = React.useRef(null);
  ...
  ☰
      ...
      <nav className={`navbar ${open ? "open" : ""}`}>
        <a href="#home" style={{"--i":"1"}} className="active" onClick={() => scrollTo(homeRef)}>Home</a>
        <a href="#about" style={{"--i":"2"}} className="active" onClick={() => scrollTo(aboutRef)}>About</a>
        <a href="#service" style={{"--i":"3"}} className="active" onClick={() => scrollTo(serviceRef)}>Services</a>
        <a href="#skill" style={{"--i":"3"}} className="active" onClick={() => scrollTo(skillsRef)}>Skills</a>
        <a href="#project" style={{"--i":"4"}} className="active" onClick={() => scrollTo(projectRef)}>Projects</a>
        <a href="#contact" style={{"--i":"4"}} className="active" onClick={() => scrollTo(contactRef)}>Contact</a>
    </nav>
   </header>
   <section id="home" ref={homeRef} style={{ height: "100vh" }}>
   ...
   <section className="about" id="about" ref={aboutRef} style={{ height: "100vh" }}>
   ...
   <br></br><br></br><br></br>
   <section>
    <div className="services" id="service"  ref={serviceRef} style={{ height: "100vh" }}>
 ...
 <h1 className="sub-title" id="skill">My <span>Skills</span></h1>
     <section  ref={skillsRef} style={{ height: "100vh" }}>
  ...
  <section id="project" ref={projectRef} style={{ height: "100vh" }}>
  ...
  <section className="contact" id="contact" ref={contactRef} style={{ height: "100vh" }}>
